...
const Page = () => {
  ...
  return (
    <div className="flex items-center  justify-center space-x-4 bg-black z-50 text-white rounded-md mx-6 my-2 p-4">
      {OPTIONS.map(({ id, title, link }) => {
        ...
        return (
          <React.Fragment key={id}>
            ...
            {id < 4 && (
              <div className="h-[1px] flex-1 flex w-[50px] bg-white"></div>
            )}
          </React.Fragment>
        );
      })}
